...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'featherlight-styles', '//cdn.rawgit.com/noelboss/featherlight/1.7.13/release/featherlight.min.css', array(), filemtime( get_stylesheet_directory() . '/assets/js/custom-script.js' ) );

    wp_enqueue_style( 'child-understrap-styles', get_stylesheet_directory_uri() . '/css/child-theme.min.css', array(), filemtime( get_stylesheet_directory() . '/assets/js/custom-script.js' ) );
